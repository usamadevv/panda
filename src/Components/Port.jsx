...
<button className='btn1w' onClick={e=>setp(0)}>Portablility</button>:

<button className='btn1w dgray' onClick={e=>setp(0)}>Portablility</button>

    }

    {p===1?

<button className=' btn5w lgray'  onClick={e=>setp(1)}>Status</button>
    :

<button className=' btn5w '  onClick={e=>setp(1)}>Status</button>

    }
    {p===2?
    
<button className='btn2w btn5w lgray'  onClick={e=>setp(2)}>Cancel process</button>
    :


<button className='btn2w btn5w'  onClick={e=>setp(2)}>Cancel process</button>
    }
 </div>
